...
# Usage: ./tests/kernel-command-line.sh [-v] [arch] [boot_type]
...
#
# Examples:
#   ./tests/kernel-command-line.sh              # Run all 5 tests
#   ./tests/kernel-command-line.sh -v           # Run all tests with verbose output
#   ./tests/kernel-command-line.sh amd64        # Run AMD64 kernel test
#   ./tests/kernel-command-line.sh amd64 kernel # Run AMD64 kernel test
#   ./tests/kernel-command-line.sh -v arm64     # Run ARM64 tests with verbose output
#   ./tests/kernel-command-line.sh arm64 image  # Run ARM64 disk image test
#
